...
import { Activity, KeyRound, Server, LogOut, Moon, Sun, ScrollText, FolderTree, Wrench } from "lucide-react";
...
const OpsPage = lazy(() =>
  import("@/components/ops-page").then((m) => ({
    default: m.OpsPage,
  })),
);

type Tab = "overview" | "credentials" | "keys" | "groups" | "traces" | "ops";
